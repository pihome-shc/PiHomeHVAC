			...
			<div class="panel-body">
				<div class="accordion" id="accordion">
    					<div class="panel">
							...
							<button class="btn btn-default btn-circle btn-xxl mainbtn animated fadeIn" data-toggle="modal" data-remote="false" data-target="#ajaxModal" data-ajax="ajax.php?Ajax=GetModal_Software_Install">
                                                        <h3 class="buttontop"><small><?php echo $lang['install_sw']; ?></small></h3>
