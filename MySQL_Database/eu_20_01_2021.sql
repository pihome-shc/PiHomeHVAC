...
INSERT INTO `gateway` VALUES (1,1,0,0,'serial','/dev/ttyS3','9600','3','5944','Wed Jan 20 17:49:00 2021',0,0,'0');
...
CREATE TABLE `gateway_logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf16 COLLATE=utf16_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `messages_in` VALUES (4,0,0,'1',0,0,3.00,'2021-01-20 16:00:02'),(5,0,0,'1',0,0,3.00,'2021-01-20 16:30:01'),(6,0,0,'1',0,0,3.00,'2021-01-20 17:00:01'),(7,0,0,'1',0,0,3.00,'2021-01-20 17:30:01');
...
INSERT INTO `system_controller` VALUES (1,0,0,0,1,1,'Gas Boiler',0,3,60,2,'2021-01-20 17:40:20',0,0,46,0,0);
...
INSERT INTO `temperature_sensors` VALUES (51,0,0,70,45,0,2,1,'Hot Water',1,1),(52,0,0,0,45,1,3,0,'Main Bedroom',1,1),(54,0,0,69,52,0,4,1,'Ground Floor',1,1);
...
INSERT INTO `userhistory` VALUES (144,'admin','0f5f9ba0136d5a8588b3fc70ec752869','2021-01-20 17:00:33','Successful','192.168.0.2');
...
INSERT INTO `zone` VALUES (69,0,0,1,1,1,'Ground Floor',2,60),(70,0,0,1,0,1,'Hot Water',3,60);
...
-- Dump completed on 2021-01-20 17:49:51
