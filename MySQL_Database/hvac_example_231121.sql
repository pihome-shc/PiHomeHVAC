...
INSERT INTO `messages_out` VALUES (29,0,0,'0',33,1,1,2,'0',1,'2021-11-23 13:25:55',0);
...
INSERT INTO `relays` VALUES (48,0,0,23,33,'Heat',2,1),(49,0,0,23,35,'Cool',3,1),(50,0,0,23,40,'Fan',4,1);
...
INSERT INTO `repository` VALUES (1,0,0,0,'pihome-shc'),(2,0,0,1,'twa127'),(3,0,0,0,'dvdcut'),(4,0,0,0,'JSa1987'),(5,0,0,0,'mjhumphrey'),(6,0,0,0,'sandreialexandru');
...
INSERT INTO `schedule_daily_time` VALUES (51,0,0,1,'06:30:00',0,0,0,'09:30:00',0,0,0,62,'WeekDays AM');
...
INSERT INTO `schedule_daily_time_zone` VALUES (51,0,0,1,51,38,19.5,0,0);
...
INSERT INTO `sensors` VALUES (55,0,0,38,24,0,0.00,1,1,0,'HVAC',0,1,0,0),(56,0,0,0,25,0,0.00,1,2,0,'Main Bedroom',0,1,0,0);
...
INSERT INTO `system` VALUES (2,1,0,'MaxAir - Smart Thermostat','1.3','211121','IE','en','Portlaoise',NULL,'aa22d10d34b1e6cb32bd6a5f2cb3fb46','','','Europe/Dublin',0,0,0,1,50);
...
INSERT INTO `system_controller` VALUES (1,0,0,0,1,0,'HVAC State',0,3,60,0,'2021-11-23 10:30:36',0,0,48,49,50);
...
INSERT INTO `user` VALUES (1,1,'Administrator','admin','','0f5f9ba0136d5a8588b3fc70ec752869','2021-11-23 13:23:53','2021-11-23 09:30:40',1);
...
CREATE TABLE `zone_current_state` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MEMORY AUTO_INCREMENT=39 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `zone_sensors` VALUES (38,0,0,38,10,30,20,3,0.5,55);
...
-- Dump completed on 2021-11-23 13:26:25
