...
www-data ALL=(ALL) NOPASSWD:/bin/mv service.tmp /lib/systemd/system/pihome_amazon_echo.service
www-data ALL=(ALL) NOPASSWD:/bin/mv service.tmp /lib/systemd/system/homebridge.service
...
$query_job_scheduling .= "VALUES ('controller','/var/www/cron/controller.php',0,0,60,''),";
$query_job_scheduling .= "('check_gw','/var/www/cron/check_gw.php',0,0,60,''),";
